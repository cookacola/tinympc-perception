        ...
        json.dumps(
            {
                ...
                "gate_count": 2,
                "gate_centers_m": [list(gate) for gate in LAYOUT["gates"]],
                "camera_to_body": {
                    "body_axes": "+x forward, +y left, +z up",
                    "opencv_camera_axes": "+x right, +y down, +z forward",
                    "rotation_body_from_camera": [[0, 0, 1], [-1, 0, 0], [0, -1, 0]],
                    "translation_body_from_camera_m": [0, 0, 0],
                    "status": "synthetic camera pose defines body attitude",
                },
